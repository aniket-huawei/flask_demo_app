...
################################################################
#
# This script is used to take an input image and output the
# scene graph prediction result
#
...
#            )
        label_str_list.append(cfg.ind_to_class[int(labels[i])])
...
#                fontsize=14, color='white')
    ...
    # draw relations
    # subject_lable, Object_label, Edge_lable, Image_id, Image_size, Sub_bbox, Obj_bbox
    csv_rows = []
